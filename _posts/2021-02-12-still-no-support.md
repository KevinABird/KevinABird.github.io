...
That these two approaches are essentially identical can be demonstrated in a simple manner. Using my F<sub>st</sub> value of 0.111 and a heritability of 0.35, Fuerst gets an estimated genetic contribution to the IQ gap of 8.85 (Table 1). If that value is multiplied by <img src="https://render.githubusercontent.com/render/math?math=\sqrt{\frac{2}{\pi}}"> it equals 7.06. 
