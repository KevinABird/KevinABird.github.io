...
### Where this is going
While I plan to continue work along all three threads above, I also see the longer arc of this program as connecting genome restructuring to biodiversity itself and asking whether lineages that restructure their genomes more readily also diversify faster, occupy broader niches, or generate greater phenotypic disparity. Bringing genome architecture together with phylogenetic, ecological, and trait data is an exciting area made tractable with recent advances in genomic sequencing, and it's the direction my work is building toward.
